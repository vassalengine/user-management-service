...
use auth_provider::{AuthProvider, Failure};
use discourse::DiscourseAuth;

use rocket::{
    Build, Request, Rocket, Route, catch, catchers, launch, post, routes,
    http::Status,
    response::status::Custom,
    serde::{
        Deserialize, Serialize,
        json::{Json, Value, json, to_value}
    }
};
...
// TODO: How do we return error JSON? Err part of Result needs to implement
// a Responder?

// TODO: mock out the auth provider
